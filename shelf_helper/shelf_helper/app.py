...
from wtforms import StringField, PasswordField, FloatField, IntegerField, BooleanField, validators
...
def admin_export_csv():
    ...
    writer.writerow(['Order ID', 'Product Name', 'Customer Name', 'User ID', 'Store', 'Timestamp'])
...
def admin_dashboard():
    ...
    return render_template('admin_dashboard.html', orders=orders, products=products, export_enabled=True)
